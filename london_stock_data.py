...
class london_stock_exchange:
    def __init__(self,config_file,stock_file,tableName):
    ...
    def use_LSE_API(self,stock):
        ...
        if site.ok:
            ...
            try:
                ...
                # create new column that is the company ticker
                self.df['ticker']=stock
    ...
    def query_postgre(self,stock):
        # max tradetime
        query='SELECT MAX("tradeTime") FROM {} WHERE ticker=\'{}\';'.format(self.tableName,stock)
        ...
        query='SELECT COUNT(price) FROM {} WHERE ticker=\'{}\';'.format(self.tableName,stock)
    ...
    def get_trade_data(self):
        ...
        for stock in self.stocks:
            ...
            if success:
                ...
                # insert to db
                self.df.to_sql(self.tableName, con=self.psql.engine, if_exists='append', index=False)
